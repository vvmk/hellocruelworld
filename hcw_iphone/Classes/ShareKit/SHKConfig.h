...
#define SHKMyAppName			@"Hello Cruel World for iPhone"
#define SHKMyAppURL				@""
...
//app id "130235233690598"
#define SHKFacebookUseSessionProxy  NO 
#define SHKFacebookKey				@"c364542af9cfca46779ade0db260b8ab"
#define SHKFacebookSecret			@"91c0760e66e9aaf22c29093ef607fde3"
 ...
 */
#define SHKTwitterConsumerKey		@"Z0HiuTkYJQsKZzIH1zteDA"
#define SHKTwitterSecret			@"GIR7RvvWStOb6IPwlB4uZ7EB0AzUYzi2q5ceZR6Y"
#define SHKTwitterCallbackUrl		@"http://hellocruelworld.net" // You need to set this if using OAuth, see note above (xAuth users can skip it)
...
#define SHKBitLyLogin				@"hcwforiphone"
#define SHKBitLyKey					@"R_4e5745789c0451b43b80b1896c863c07"
